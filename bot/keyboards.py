...
admin_panel = [
    ...
    [KeyboardButton("Повідомити усіх вчителів 🔔"), KeyboardButton("Видалити сповіщення учням 🗑️")],
    [KeyboardButton("Повідомити усіх учнів 🔔"), KeyboardButton("Видалити сповіщення вчителям 🗑️")]
]
